                           ...
                           int32_t abs_y, int32_t max_main_size, int32_t item_gap, track_t * t)
{
    ...
    margin_func_t get_margin_main_start = (f->row ? lv_obj_get_style_margin_left_internal : lv_obj_get_style_margin_top_internal);
    margin_func_t get_margin_main_end = (f->row ? lv_obj_get_style_margin_right_internal : lv_obj_get_style_margin_bottom_internal);
    margin_func_t get_margin_cross_start = (!f->row ? lv_obj_get_style_margin_left_internal : lv_obj_get_style_margin_top_internal);
    margin_func_t get_margin_cross_end = (!f->row ? lv_obj_get_style_margin_right_internal : lv_obj_get_style_margin_bottom_internal);
