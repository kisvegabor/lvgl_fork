...
/**
 * Set a name for a widget. The name will be allocated when save
 * @param obj       pointer to an object
...
/**
 * Get the set name or craft a name automatically if the is not set name.
 * The crafted names are built like <widget type> + "_" + <index of the given type>
 * For example if a parent has 2 button and two label children the names will be
 * "lv_button_1", "lv_button2", "lv_label_1", "lv_label_2"
 * The <widget name> comes from the `class->name` filed.
 * The index is 1 based.
 * @param obj       pointer to an object
 * @param buf       buffer to store the name
 * @param buf_size  the suze of the buffer in bytes
 */
 ...
 * and the direct children of the first child, etc. (Breath-first search).
 *
